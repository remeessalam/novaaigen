    ...
    <div className="py-[5rem] bg-[#101010] text-white">
      ...
      >
        ...
        <div className="flex flex-col gap-6 tex-white pb-[2rem]">
          ...
          <h2 className="text-[1.8rem] text-center font-semibold mt-7 leading-tight font-raleway">
            What We Offer :
          </h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
            {selectedService.whatWeOffer.map((offer) => (
              <div className="p-4 min-h-[12rem] rounded-xl border border-white/20">
                <h4 className="text-[1.4rem] font-medium leading-tight mb-2">
                  {offer.title}
                </h4>
