...
const LandingPage = ({ page }) => {
  ...
  if (page === "web") {
    ...
    aboutDesc =
      "Unlock the power of Artificial Intelligence to revolutionize your operations, elevate customer experiences, and drive growth. At AI Company, we deliver state-of-the-art AI solutions tailored to your business needs.";
  } else {
    ...
    aboutDesc =
      "Step into the future with Internet of Things (IoT) solutions designed to connect your devices, streamline operations, and deliver actionable insights. At AI Company, we turn ideas into intelligent systems that redefine how businesses operate.";
  }
      ...
      <section className="py-[5rem] bg-black text-white">
        <div className="wrapper text-center flex flex-col gap-3">
          ...
          <p data-aos="fade-up" className="desc max-w-[50rem] mx-auto">
            At AI Company LLP, we understand that in today’s
